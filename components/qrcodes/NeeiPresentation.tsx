...
export const NeeiPresentation: React.FC<NeeiPresentationProps> = ({
  ...
  return (
    <div className={`min-h-screen flex flex-col font-sans transition-colors duration-300 ${pageBg}`}>
      ...
      <div
        ref={slideRef}
        className={`flex-1 flex flex-col justify-center items-center transition-colors duration-300 ${pageBg} ${
          isFullscreen
      ...
      >
        ...
        <div className="w-full space-y-8 max-w-5xl my-auto">
          ...
          <div className="text-center space-y-3">
            <div className="flex items-center justify-center gap-3">
              <img
                ...
                onError={(e) => {
                  // Fallback if needed
                  (e.target as HTMLImageElement).src = '/assets/neei-logo1.png'
                }}
              />
              <div className="text-left leading-tight">
                ...
                <span className={`text-[11px] font-medium block ${isDark ? 'text-cyan-400' : 'text-[#00668c]'}`}>
              ...
              return (
                ...
                >
                  ...
                  <div className="w-full mt-4 space-y-2">
                    <div className={`p-2 rounded-xl text-center font-mono text-[11px] truncate border ${
                      isDark ? 'bg-slate-900/80 border-slate-800 text-cyan-300' : 'bg-slate-50 border-slate-200 text-[#00668c]'
                    }`}>
                      {card.url}
                    </div>
          ...
          <div className={`relative overflow-hidden rounded-3xl p-5 sm:p-6 border transition-all duration-300 shadow-md ${
            isDark
