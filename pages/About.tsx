          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 justify-items-center">
            {direcao.map((member) => (
              <div key={member.name} className="flex flex-col items-center text-center group">
                <div className="relative w-32 h-32 md:w-36 md:h-36 mb-4 overflow-hidden rounded-full border-4 border-primary-100 dark:border-cyan-900/60 group-hover:border-accent-200 dark:group-hover:border-cyan-400 transition-all duration-300 shadow-md bg-white dark:bg-slate-800">
                  <img
        ...
        <div className="mb-14">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 justify-items-center">
            {mesaPlenario.map((member) => (
              <div key={member.name} className="flex flex-col items-center text-center group">
                <div className="relative w-28 h-28 md:w-32 md:h-32 mb-4 overflow-hidden rounded-full border-4 border-bg-200 dark:border-slate-800 group-hover:border-accent-200 dark:group-hover:border-cyan-400 transition-all duration-300 shadow-sm bg-white dark:bg-slate-800">
                  <img
                    src={getMemberPhoto(member.name, member.role)}
                    alt={member.name}
                    className="w-full h-full object-cover scale-[1.02] transition-transform duration-300 group-hover:scale-105"
